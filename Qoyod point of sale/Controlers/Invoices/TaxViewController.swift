...
class TaxViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        txtTax.text = product.deleted_at
    }
    ...
    {
        lblMain.text = languageBundle!.localizedString(forKey: "Tax Amount", value: "", table: nil)
        lblText.text = languageBundle!.localizedString(forKey: "Enter the amount of tax", value: "", table: nil)
...
extension TaxViewController: UITextFieldDelegate
{
