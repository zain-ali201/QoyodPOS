...
//
//                resultTitle += "\u{200E}" + getPaddedString(str1:shortName , str2: quantity, str3: price) + "\u{200E}"
//
//                if name.count > 10 {
...
//                + "         POS Invoice #" + posNo + "</br>"
            ...
            {
                textToPrint = String(format: "%@ Paid: %.1f</br> Remaining: %.1f</br>--------------------------------</br></div></html>",textToPrint, paidAmount, totalamountWithTax - paidAmount)
            }
            else
            {
                textToPrint = textToPrint + "--------------------------------</br></div></html>"
            }
